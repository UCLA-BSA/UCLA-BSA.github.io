function navcard(args, kwargs)
  ...
  while true do
    ...
    local target_raw = kwargs["target" .. i]
    local target = target_raw and pandoc.utils.stringify(target_raw) or "_self"
    ...
    items = items ..
      '<a href="' .. href .. '" target="' .. target .. '" ' .. hidden .. ' style="text-decoration:none; border-left:4px solid ' .. color .. ';">' ..
