...
image: ../images/emilie-campos.jpg
about:
  template: trestles
  links:
    - icon: envelope
    ...
    - icon: twitter
      text: Twitter
      href: https://twitter.com/emjcampos
    - icon: github
      text: Github
      href: https://github.com/emjcampos
---
...
Feel free to email me if you want pictures of my dog. Here's a sample: ![](../images/charlie.jpg)