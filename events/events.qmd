...
(function () {
  ...
  (function () {
    ...
    function idRender(items) {
      ...
      if (!list) return;
      // skip rows with no title or no date
      ...
      if (upcoming.length === 0) {
        list.innerHTML = '<li class="important-dates-empty">📭 No upcoming dates.</li>';
        return;
      }
      list.innerHTML = upcoming.map(function(d) {
        ...
        var titleHTML = d.link
          ? '<a href="' + d.link + '" target="_blank" rel="noopener" class="important-date-link">' + d.title + '</a>'
          : '<span>' + d.title + '</span>';
        return '<li class="important-date-item">' +
          '<span class="date-dot ' + uc + '"></span>' +
          '<span class="date-item-title">' + titleHTML + '</span>' +
          '<span class="date-item-meta">' +
            '<span class="date-item-tag ' + uc + '">' + tag + '</span>' +
            '<span class="date-item-date">' + idFormatDate(d.date) + '</span>' +
          '</span>' +
        '</li>';
      }).join('');
    }
...
<div class="important-dates-section">
  ...
  <ul class="important-dates-list" id="importantDatesList">
    <li class="important-dates-loading">Loading&hellip;</li>
  </ul>
</div>
```
